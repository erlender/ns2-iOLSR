...
#Agent/OLSR set wsn_incr_factor_z_ 2;

Agent/OLSR set wsn_z_base_ 1;
Agent/OLSR set wsn_z_incr_ 1;
...
Agent/OLSR set tcttl_ false;
Agent/OLSR set force_vttc_max_ false;
...
set val(initeng)        50000.0                        ;# Initial energy in Joules
...
set opt(stop)		300000.0		;# simulation time
...
for {set i 200000} {$i<200001} {incr i} {
