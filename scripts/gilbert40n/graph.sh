...
# iOLSR
for i in collisions goodput nrte ttl; do # arp cbk collisions delay end goodput hops ifq jitter loop nrte recvspp sentpkts transmissions ttl; do
touch tmp.tmp;
rm tmp.tmp;
t="reset;"
...
for i in collisions goodput hops nrte ttl; do # arp cbk collisions delay end goodput hops ifq jitter loop nrte recvspp sentpkts transmissions ttl; do
touch tmp.tmp;
rm tmp.tmp;
t="reset;"
#t="$t set title \"Study of node birth impact\";"
