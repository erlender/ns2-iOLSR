...
#datacols="1:(\$2+\$3+\$4)/3"; linestype="linespoints"
...
#let col=col+1;
t="$t 'wsnolsr_TCTTL2_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL2' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1;"
let col=col+1;
...
#let col=col+1;
t="$t 'wsnolsr_TCTTL2_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp TCTTL2' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1;"
let col=col+1;
