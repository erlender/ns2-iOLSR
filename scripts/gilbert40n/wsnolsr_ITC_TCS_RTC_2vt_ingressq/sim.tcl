...
Agent/OLSR set wsn_incr_factor_z_ 1;

Mac/802_11 set gilbertchange $opt(gilbertchange) ;# in millionth
Mac/802_11 set ingress true;
Agent/OLSR set immediatetrans_ true;
Agent/OLSR set tcsolicit_ true;
Agent/OLSR set reversetc_ true;
Agent/OLSR set vtimeweight_ 2;
