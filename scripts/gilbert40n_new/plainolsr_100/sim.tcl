...
Agent/OLSR set hello_ival_  100.0
Agent/OLSR set tc_ival_     250.0
Agent/OLSR set mid_ival_    250.0
...
set opt(stop)		6000.0		;# simulation time
...
# These nodes die at 300 s simulation time
#for {set i 0} {$i < $lowm} {incr i} {
#$ns_ at 300 "$node_($i) setenergy 0"
#puts "Node $i will die at 300s"
#}
