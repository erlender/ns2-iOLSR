...
#datacols="1:(\$2+\$3+\$4+\$5)/4"; linestype="linespoints"
...
#let col=col+1;
t="$t 'wsnolsr_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp2' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
let col=col+1;
#t="$t 'wsnolsr_TCTTL_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
#let col=col+1;
t="$t 'wsnolsr_TCTTL1_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL 1buf' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
let col=col+2;
#t="$t 'wsnolsr_TCTTL2_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL 2buf' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
#let col=col+1;
#t="$t 'wsnolsr_TCTTL22_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL 2buf prevTO' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
#let col=col+1;
#t="$t 'wsnolsr_TCTTL1vtmax_exp2/results/600-5900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL 1buf vtmax' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1;"
#let col=col+1;
#t="$t 'wsnolsr_TCTTL1vtmax_exp2_18000s/results/600-17900s_tos1_$i.coi' using $datacols title 'Incr exp TCTTL 1buf vtmax 18ks' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1;"
#let col=col+1;
...
#let col=col+1;
t="$t 'wsnolsr_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp2' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
let col=col+1;
#t="$t 'wsnolsr_TCTTL_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp TCTTL' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
#let col=col+1;
t="$t 'wsnolsr_TCTTL1_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp TCTTL 1buf' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
let col=col+2;
#t="$t 'wsnolsr_TCTTL2_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp TCTTL 2buf' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
#let col=col+1;
#t="$t 'wsnolsr_TCTTL22_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp TCTTL 2buf prevTO' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1,"
#let col=col+1;
#t="$t 'wsnolsr_TCTTL1vtmax_exp2/results/600-5900s_$i.coi' using $datacols title 'Incr exp TCTTL 1buf vtmax' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1;"
#let col=col+1;
#t="$t 'wsnolsr_TCTTL1vtmax_exp2_18000s/results/600-17900s_$i.coi' using $datacols title 'Incr exp TCTTL 1buf vtmax 18ks' with $linestype lw $lw lc $col lt $col ps $ps axis x1y1;"
#let col=col+1;
